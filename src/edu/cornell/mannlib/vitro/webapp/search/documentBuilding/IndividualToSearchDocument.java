...
import static edu.cornell.mannlib.vitro.webapp.search.VitroSearchTermNames.SEARCH_TERM;
...
public class IndividualToSearchDocument {
    ...
    protected final String bsearch = "http://library.brown.edu/ontology/search#";
    ...
    protected void addSearchTerms(Individual ind, SearchInputDocument doc) {
        //add Brown search terms for best bets.
        String dp = bsearch + "searchTerm"; 
        List<String> values = ind.getDataValues(dp);
        doc.addField(SEARCH_TERM, values);
    }
